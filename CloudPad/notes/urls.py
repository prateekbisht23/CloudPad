...
from .views import note_view, save_note, load_note, home, about, repo_finder, find_repositories

urlpatterns = [
    path('', home, name='home'),
    path("about/", about, name='about'),
    path("repo-finder/", repo_finder, name='repo_finder'),
    path("api/find-repositories/", find_repositories, name='find_repositories'),
